    ...
    public partial class PostgresInitialSetup : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "UP Health Dept", new DateTime(2026, 9, 7, 18, 55, 47, 59, DateTimeKind.Local).AddTicks(8330), 12500000m, "Installation", 65, "Roorkee Medical College Solar Hub", "On-Grid", "RRC Slab", 0, "Roorkee, UK", 450.0 },
                    { 2, "Smart City Auth", new DateTime(2026, 9, 7, 18, 55, 47, 59, DateTimeKind.Local).AddTicks(9470), 4200000m, "Site Survey", 15, "Meerut IT Park Unit 4", "Hybrid", "RRC Slab", 0, "Meerut, UP", 120.5 }
                });
